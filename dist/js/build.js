...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ractive = __webpack_require__(5);
	...
	var numberToWordView = function () {
	    function numberToWordView() {
	        ...
	        this.view = new _ractive2.default({
	    ...
	    _createClass(numberToWordView, [{
	        ...
	        value: function attachEvents() {
	            ...
	            this.view.on('updateValue', function (event) {
	
	                var number = _numberValidator2.default.getValidIntegerFromString(event.node.value, 0, 1000);
	                ...
	                if (number !== false) {
	                    ...
	                    _this.view.set('error', _this.errorMsg);
	                    _this.view.set('words', '');
	                }
	            });
	        }
	    }]);
...
/***/ function(module, exports) {
	...
	var numberToWord = function () {
	    ...
	    _createClass(numberToWord, [{
	        ...
	        key: "convertNumberLessThan20",
	        value: function convertNumberLessThan20(number) {
	        ...
	        key: "convertNumberLessThan100",
	        value: function convertNumberLessThan100(number) {
	
	            var words = [];
	
	            var tens = this.getTensFromNumber(number);
	            words.push(this.tens[tens]);
	
	            var ones = this.getSingleFromNumber(number);
	        ...
	        key: "convertNumberGreaterThan100",
	        value: function convertNumberGreaterThan100(number) {
	
	            var words = [];
	
	            var hundreds = this.getHundredsFromNumber(number);
	        ...
	        key: "getSingleFromNumber",
	        value: function getSingleFromNumber(number) {
	            return number % 10;
	        }
	        ...
	        key: "getHundredsFromNumber",
	        value: function getHundredsFromNumber(number) {
	        ...
	        key: "getTensFromNumber",
	        value: function getTensFromNumber(number) {
...
/***/ function(module, exports) {
	...
	var numberValidator = function () {
	    ...
	    _createClass(numberValidator, null, [{
	         ...
	         * @returns {*}
	         */
	        value: function getValidIntegerFromString(numString, rangeMin, rangeMax) {
	        ...
	        key: 'isStringValueValidInteger',
	        value: function isStringValueValidInteger(number) {
...
/***/ function(module, exports) {
	...
	module.exports = "<input on-keyup=\"updateValue\" class=\"form-control\" name=\"number\" placeholder=\"number\" value='{{number}}'>\n<h1>{{words}}</h1>\n<h2>{{error}}</h2>";
